...
| --- | --- |
| ![](images/00024-3725388656.png){: width="50%"} | ![](images/00028-3725388656.png){: width="50%"} |

우선 생성된 이미지 중 의도한 것과 일치하는 부분을 가진 이미지들을 모음.  

| 합쳐진 이미지 | 머리 색상 보정 |
| --- | --- |
| ![](images/00024-3725388656_modified.png){: width="50%"} | ![](images/00024-3725388656_modified_haircolor.png){: width="50%"} |

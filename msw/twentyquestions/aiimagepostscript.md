...
* 생성된 이미지 중 의도와 일치하는 부분을 가진 이미지들을 모음
...
* 범위를 좁혀 대량의 이미지를 빠르게 뽑아내 선별할 수 있는 시스템을 구축할 수 있다면 베스트일 듯
...
* 소규모 게임이면 어느정도 넘어갈 수 있겠지만, 어설픈 이미지는 대기업 게임에서 그대로 쓰기에는 확실히 무리가 있음
